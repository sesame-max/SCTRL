...
#define BACKCOLOR LBBLUE // 定义背景色
// #define BACKCOLOR BLACK //定义背景色
...
void LCD_ShowString(uint16_t x, uint16_t y, char *p, uint16_t fc, uint16_t bc, uint8_t sizey, uint8_t mode);     // 显示字符串
